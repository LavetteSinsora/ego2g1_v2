...
class EmbodimentTag(Enum):
    ...
    UNITREE_G1_Dex1 = "unitree_g1_dex1"
    """
    The Unitree G1 robot with Dex1 gripper.
    """

    unitree_g1_wbc_dex1 = "unitree_g1_wbc_dex1"
    """
    The Unitree G1 robot with Dex1 gripper, using the whole body control.
    """

    UNITREE_G1_DEX3 = "unitree_g1_dex3"
    """
    The Unitree G1 robot with Dex3 gripper.
    """

    UNITREE_G1_BRAINCO = "unitree_g1_brainco"
    """
    The Unitree G1 robot with Brainco gripper.
    """
    ##### UNITREE #####
