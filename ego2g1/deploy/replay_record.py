"""Moved to ego2g1/deploy/record/session_reader.py (docs/deploy_refactor_plan.md
...
if __name__ == "__main__":
    ...
    runpy.run_module("ego2g1.deploy.record.session_reader",
                     run_name="__main__", alter_sys=True)
else:
    import sys as _sys

    from .record import session_reader as _mod
