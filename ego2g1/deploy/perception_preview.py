"""Moved to ego2g1/deploy/ui/perception_preview.py (docs/deploy_refactor_plan.md
...
if __name__ == "__main__":
    ...
    runpy.run_module("ego2g1.deploy.ui.perception_preview",
                     run_name="__main__", alter_sys=True)
else:
    import sys as _sys

    from .ui import perception_preview as _mod
