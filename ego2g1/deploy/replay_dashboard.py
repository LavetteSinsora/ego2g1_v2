"""Moved to ego2g1/deploy/ui/replay_dashboard.py (docs/deploy_refactor_plan.md
...
if __name__ == "__main__":
    ...
    runpy.run_module("ego2g1.deploy.ui.replay_dashboard",
                     run_name="__main__", alter_sys=True)
else:
    import sys as _sys

    from .ui import replay_dashboard as _mod
