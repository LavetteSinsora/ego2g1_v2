"""Moved to ego2g1/deploy/tools/sniff_lowcmd.py (docs/deploy_refactor_plan.md
...
if __name__ == "__main__":
    ...
    runpy.run_module("ego2g1.deploy.tools.sniff_lowcmd",
                     run_name="__main__", alter_sys=True)
else:
    import sys as _sys

    from .tools import sniff_lowcmd as _mod
